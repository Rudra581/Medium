...
export const extractTextForAI = (content: string): string => {
    try {
...
async function summarizeBlog(text: string) {
...
async function cloudflare_image_generator(title: string, env: any) {
    try {
