...
import { insertPost, updatePost, getAllPosts, getPostByUserId, getPostByPostId, getCommentByPostId, createcomment, createrating, getRatingByPostId, GetAllCategories, GetPostByCategories } from "../../DB/db";
